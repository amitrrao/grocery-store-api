...
/**
 * This is the domain object that represents a the internal details of a GroceryItem. 
 * 
 * It is used by JPA to persist data in the database in a separate table called `INTERNAL_DETAILS`.
 * 
 * @author arao
 *
 */
